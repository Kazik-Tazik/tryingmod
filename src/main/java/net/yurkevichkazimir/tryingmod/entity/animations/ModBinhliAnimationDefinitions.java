...
public class ModBinhliAnimationDefinitions {
    public static final AnimationDefinition BINHLI_IDLE = AnimationDefinition.Builder.withLength(5.0F).looping()
            ...
            .addAnimation("left_antena", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(2.374F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.375F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -29.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("right_antena", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(4.0833F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -22.5F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(4.1667F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 35.0F), AnimationChannel.Interpolations.LINEAR),
