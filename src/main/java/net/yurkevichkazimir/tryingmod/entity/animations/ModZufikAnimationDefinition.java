...
public class ModZufikAnimationDefinition {
    public static final AnimationDefinition ZUFIK_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition ZUFIK_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("zufik", new AnimationChannel(AnimationChannel.Targets.POSITION,
